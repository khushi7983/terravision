...
const page = () => {
  return (
    <div className=' items-center justify-center flex  gap-4 w-full  px-20 text-center min-h-screen bg-slate-300'    style={{
      ...
      <div className='w-3/5 bg-customColor p-5 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12'>
      ...
      <a href='#' className='border-2 border-white rounded-full px-12 py-2 font-semibold hover:bg-white hover:text-gray-700'>Sign Up</a>
      ...
      <div className='flex flex-col items-center mt-10'>
       ...
       <a href='#' className='border-2 border-white rounded-full px-12 py-2 font-semibold hover:bg-white hover:text-gray-700'>Login</a>
